...
(use-package rtags
  ...
  :config (setq rtags-completions-enabled t
	            ...
	            ;;rtags-rc-binary-name "/home/th/.emacs.d/rtags/bin/rc"
...
(th/leader-keys ; Buffer management
  ...
  "r ?" '(rtags-find-symbol-at-point :wk "find symbol in project")
  "r b" '(rtags-location-stack-back :wk "go back to previous location")
)
